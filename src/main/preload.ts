...
const api = {
  ...
  getStorageInfo: () => ipcRenderer.invoke(CH.GET_STORAGE_INFO),
  pickDataDir: () => ipcRenderer.invoke(CH.PICK_DATA_DIR),
  changeDataDir: (targetDir: string | null) =>
    ipcRenderer.invoke(CH.CHANGE_DATA_DIR, targetDir),
